...
// sumDebtAmountsByCurrency totals what a set of entries comes to, one total per currency
export function sumDebtAmountsByCurrency(entries: DebtEntryInfoResponse[]): DebtAmount[] {
